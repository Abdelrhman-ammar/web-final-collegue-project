...
if(isset($_SESSION['name']) && $_SESSION['role']==1)
{
    ...
    ?>
         <div class="container">
           ...
           <span id="add_new_book" class="btn btn-primary mb-3 mt-3" onclick="destination('books.php?do=addBook');"> add new book</span> 
                            ...
                            foreach($all_books as $book)
                            {
                              ...
                              <div class="book" id="item<?php echo $book['id']; ?>">
                                ...
                                <p class="borrow"><?php if($book['borrower_id'] !=0){echo "The book is borrowed";}else{echo "The book is allowed";} ?></p>
                                 ...
                                 <form method="POST" action="books.php?do=edit&id=<?php echo $book['id'] ?>">
                                  <button class="btn btn-primary btn-sm">edit</button>
                                 </form>
                                 <form method="POST" action="books.php?do=delete&id=<?php echo $book['id'] ?>">
    ...
    ?>
      <div class="container">
                <div class="card card_ d-flex justify-content-center" >
                        ...
                        <div class="card-body">
                            <form action="books.php?do=addBook_to_database" name="form" method="POST" onsubmit = "return(validation_add_book());"> 
    ...
    else if($do=="edit")
    {
        ...
        if($_SERVER['REQUEST_METHOD']=='POST')
        {
            ...
            <div class="card d-flex justify-content-center" >
                    ...
                    <div class="card-body">
                        <form action="books.php?do=update&id=<?php echo $id?>" method="POST" name="form" onsubmit = "return(validation_add_book());"> 
